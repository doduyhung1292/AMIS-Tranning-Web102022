...
<script>
    ...
    export default {
        name: "TableEmployees",
        components: {LoadingDataTable, DialogConfirm},
             ...
             */
             axios.get(`https://amis.manhnv.net/api/v1/Employees/filter?pageSize=${this.numberPerPage}&pageNumber=1`)
                .then(res => {this.employees = res.data.Data; 
                                ...
                                this.$emit('getEmployeeLength', res.data.TotalRecord, res.data.TotalPage, res.data.CurrentPage, res.data.CurrentPageRecords)})
              ...
              responseApiDelete: function(res) {
                try {
                    ...
                    case 200:
                        ...
                        this.$emit('updateTotalRowOnTable', this.employees.length)
                        break;
                    default:
                        break;
                    }
